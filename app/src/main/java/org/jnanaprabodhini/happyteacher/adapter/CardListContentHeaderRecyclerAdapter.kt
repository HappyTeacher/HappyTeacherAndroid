 ...
 */
abstract class CardListContentHeaderRecyclerAdapter<VH: CardListHeaderViewHolder>(options: FirebaseRecyclerOptions<CardListContentHeader>, val activity: Activity, val topicName: String, firebaseDataObserver: FirebaseDataObserver):
        FirebaseObserverRecyclerAdapter<CardListContentHeader, VH>(options, firebaseDataObserver) {
 ...
 */
class LessonHeaderRecyclerAdapter(topicName: String, options: FirebaseRecyclerOptions<CardListContentHeader>, activity: Activity, firebaseDataObserver: FirebaseDataObserver):
 ...
 */
class ClassroomResourcesHeaderRecyclerAdapter(topicName: String, options: FirebaseRecyclerOptions<CardListContentHeader>, activity: Activity, firebaseDataObserver: FirebaseDataObserver):
